...
class Favorite(db.Model):
    ...
    def to_dict(self):
        ...
        fav_user = None
        if self.favorite_user and self.favorite_user.profile:
            fav_user = self.favorite_user.profile.to_dict()
            fav_user['user_id'] = self.favorite_user_id
        return {
            'id': self.id,
            'user_id': self.user_id,
            'favorite_user_id': self.favorite_user_id,
            'favorite_user': fav_user,
